...
Shader "AmplifyShaderPack/Baked GI Specular Cutout"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 CalculateShadowMask1_g36( half2 LightmapUV )
			{
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float3 Normal1069_g32 = temp_output_975_0_g32;
				float3 tanToWorld0 = float3( WorldTangent.x, WorldBiTangent.x, WorldNormal.x );
				float3 tanToWorld1 = float3( WorldTangent.y, WorldBiTangent.y, WorldNormal.y );
				float3 tanToWorld2 = float3( WorldTangent.z, WorldBiTangent.z, WorldNormal.z );
				float3 tanNormal1158_g32 = Normal1069_g32;
				float3 worldNormal1158_g32 = normalize( float3(dot(tanToWorld0,tanNormal1158_g32), dot(tanToWorld1,tanNormal1158_g32), dot(tanToWorld2,tanNormal1158_g32)) );
				...
				float3 bakedGI1252_g32 = ASEBakedGI( worldNormal1158_g32, UV1Static1247_g32, true);
				float3 lerpResult1169_g32 = lerp( float3( 1,1,1 ) , bakedGI1252_g32 , _IndirectDiffuse);
				float3 temp_output_1173_0_g32 = ( lerpResult1169_g32 + step( float3( 1,1,1 ) , ( 1.0 - lerpResult1169_g32 ) ) );
				float ase_lightAtten = 0;
				Light ase_mainLight = GetMainLight( ShadowCoords );
				ase_lightAtten = ase_mainLight.distanceAttenuation * ase_mainLight.shadowAttenuation;
				float temp_output_1108_0_g32 = ( 1.0 - ( ( 1.0 - ase_lightAtten ) * _MainLightPosition.w ) );
				float ase_lightIntensity = max( max( _MainLightColor.r, _MainLightColor.g ), _MainLightColor.b );
				float4 ase_lightColor = float4( _MainLightColor.rgb / ase_lightIntensity, ase_lightIntensity );
				float LightColorIntensity1349_g32 = max( ase_lightColor.a , 0.0 );
				float3 temp_output_1112_0_g32 = ( temp_output_1173_0_g32 * temp_output_1108_0_g32 * LightColorIntensity1349_g32 );
				float3 tanNormal1072_g32 = temp_output_975_0_g32;
				float3 worldNormal1072_g32 = normalize( float3(dot(tanToWorld0,tanNormal1072_g32), dot(tanToWorld1,tanNormal1072_g32), dot(tanToWorld2,tanNormal1072_g32)) );
				float3 normalizeResult1044_g32 = ASESafeNormalize( ( WorldViewDirection + SafeNormalize(_MainLightPosition.xyz) ) );
				float dotResult1046_g32 = dot( worldNormal1072_g32 , normalizeResult1044_g32 );
				float Dot_NdotH1098_g32 = dotResult1046_g32;
				float dotResult1055_g32 = dot( worldNormal1072_g32 , SafeNormalize(_MainLightPosition.xyz) );
				float Dot_NdotL1100_g32 = dotResult1055_g32;
				float lerpResult1130_g32 = lerp( ( _ShadowStrength * _ShadowStrength * 0.7978846 ) , ( _ShadowStrength * _ShadowStrength * sqrt( ( 2.0 / ( 2.0 * PI ) ) ) ) , _ShadowApproxmation);
				float RoughnessApproxmation1138_g32 = lerpResult1130_g32;
				float temp_output_1312_0_g32 = ( ( max( Dot_NdotL1100_g32 , 0.0 ) * RoughnessApproxmation1138_g32 ) + ( 1.0 - RoughnessApproxmation1138_g32 ) );
				float temp_output_1308_0_g32 = ( max( Dot_NdotH1098_g32 , 0.0 ) * temp_output_1312_0_g32 * temp_output_1312_0_g32 );
				float3 worldPosValue44_g38 = WorldPosition;
				float3 WorldPosition86_g38 = worldPosValue44_g38;
				float4 ase_screenPosNorm = ScreenPos / ScreenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float2 ScreenUV75_g38 = (ase_screenPosNorm).xy;
				float2 ScreenUV86_g38 = ScreenUV75_g38;
				float3 tanNormal12_g38 = Normal1069_g32;
				float3 worldNormal12_g38 = normalize( float3(dot(tanToWorld0,tanNormal12_g38), dot(tanToWorld1,tanNormal12_g38), dot(tanToWorld2,tanNormal12_g38)) );
				float3 worldNormalValue50_g38 = worldNormal12_g38;
				float3 WorldNormal86_g38 = worldNormalValue50_g38;
				half2 LightmapUV1_g36 = UV2Dynamic1251_g32;
				half4 localCalculateShadowMask1_g36 = CalculateShadowMask1_g36( LightmapUV1_g36 );
				float4 shadowMaskValue33_g38 = localCalculateShadowMask1_g36;
				float4 ShadowMask86_g38 = shadowMaskValue33_g38;
				float3 localAdditionalLightsLambertMask14x86_g38 = AdditionalLightsLambertMask14x( WorldPosition86_g38 , ScreenUV86_g38 , WorldNormal86_g38 , ShadowMask86_g38 );
				float3 lambertResult38_g38 = localAdditionalLightsLambertMask14x86_g38;
				float3 temp_cast_1 = (temp_output_1108_0_g32).xxx;
				float3 lerpResult1109_g32 = lerp( ( saturate( ( ( ( temp_output_1308_0_g32 * lambertResult38_g38 ) + _ShadowOffset ) / _ShadowSharpness ) ) * ase_lightAtten ) , temp_cast_1 , _ShadowStrength);
				float3 LightColor1348_g32 = ase_lightColor.rgb;
				float3 temp_output_1125_0_g32 = ( lerpResult1109_g32 * LightColor1348_g32 * ( ( 1.0 - _ShadowIntensity ) * 10.0 ) );
				...
				float3 temp_output_898_0_g32 = temp_output_89_0_g31;
				float3 temp_output_1210_0_g32 = saturate( ( ( temp_output_1112_0_g32 + temp_output_1125_0_g32 ) * temp_output_898_0_g32 ) );
				float3 worldPosValue44_g33 = WorldPosition;
				float3 WorldPosition70_g33 = worldPosValue44_g33;
				float2 ScreenUV75_g33 = (ase_screenPosNorm).xy;
				float2 ScreenUV70_g33 = ScreenUV75_g33;
				float3 tanNormal1260_g32 = Normal1069_g32;
				float3 worldNormal1260_g32 = normalize( float3(dot(tanToWorld0,tanNormal1260_g32), dot(tanToWorld1,tanNormal1260_g32), dot(tanToWorld2,tanNormal1260_g32)) );
				float3 worldNormalValue50_g33 = worldNormal1260_g32;
				float3 WorldNormal70_g33 = worldNormalValue50_g33;
				float3 temp_output_15_0_g33 = WorldViewDirection;
				float3 WorldView70_g33 = temp_output_15_0_g33;
				float3 temp_output_1196_0_g32 = (_IndirectSpecularColor).rgb;
				float3 temp_output_14_0_g33 = temp_output_1196_0_g32;
				float3 SpecColor70_g33 = temp_output_14_0_g33;
				float temp_output_18_0_g33 = _IndirectSpecularSmoothness;
				float Smoothness70_g33 = temp_output_18_0_g33;
				float3 localAdditionalLightsSpecular14x70_g33 = AdditionalLightsSpecular14x( WorldPosition70_g33 , ScreenUV70_g33 , WorldNormal70_g33 , WorldView70_g33 , SpecColor70_g33 , Smoothness70_g33 );
				float3 specularResult61_g33 = localAdditionalLightsSpecular14x70_g33;
				float3 LightColorAtten1105_g32 = ( ase_lightAtten * ase_lightColor.rgb );
				float3 normalizeResult1197_g32 = normalize( ( WorldViewDirection + SafeNormalize(_MainLightPosition.xyz) ) );
				float dotResult1187_g32 = dot( normalizeResult1197_g32 , worldNormal1260_g32 );
				float3 temp_output_1192_0_g32 = ( temp_output_1196_0_g32 * LightColorAtten1105_g32 * pow( max( dotResult1187_g32 , 0.0 ) , exp2( (_IndirectSpecularSmoothness*10.0 + 1.0) ) ) );
				float3 temp_output_1202_0_g32 = ( specularResult61_g33 + temp_output_1192_0_g32 );
				float3 BaseColor1240_g32 = temp_output_898_0_g32;
				float3 switchResult1238_g32 = (((ase_vface>0)?(( temp_output_1202_0_g32 + 0.0 )):(BaseColor1240_g32)));
				float fresnelNdotV1262_g32 = dot( worldNormal1260_g32, WorldViewDirection );
				float fresnelNode1262_g32 = ( 0.04 + _IndirectSpecularSmoothness * pow( 1.0 - fresnelNdotV1262_g32, 5.0 ) );
				float3 lerpResult1236_g32 = lerp( temp_output_1210_0_g32 , switchResult1238_g32 , saturate( fresnelNode1262_g32 ));
				...
				float3 BaseColor = lerpResult1236_g32;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN , bool ase_vface : SV_IsFrontFace ) : SV_TARGET
			{
				...
				float3 tanNormal1158_g32 = Normal1069_g32;
				float3 worldNormal1158_g32 = normalize( float3(dot(tanToWorld0,tanNormal1158_g32), dot(tanToWorld1,tanNormal1158_g32), dot(tanToWorld2,tanNormal1158_g32)) );
				float2 temp_output_1219_0_g32 = (IN.ase_texcoord4.zw*(unity_LightmapST).xy + (unity_LightmapST).zw);
				float2 UV1Static1247_g32 = temp_output_1219_0_g32;
				...
				float3 normalizeResult1044_g32 = ASESafeNormalize( ( ase_worldViewDir + SafeNormalize(_MainLightPosition.xyz) ) );
				float dotResult1046_g32 = dot( worldNormal1072_g32 , normalizeResult1044_g32 );
				float Dot_NdotH1098_g32 = dotResult1046_g32;
				float dotResult1055_g32 = dot( worldNormal1072_g32 , SafeNormalize(_MainLightPosition.xyz) );
				float Dot_NdotL1100_g32 = dotResult1055_g32;
				...
				float3 temp_output_15_0_g33 = ase_worldViewDir;
				float3 WorldView70_g33 = temp_output_15_0_g33;
				float3 temp_output_1196_0_g32 = (_IndirectSpecularColor).rgb;
				float3 temp_output_14_0_g33 = temp_output_1196_0_g32;
				float3 SpecColor70_g33 = temp_output_14_0_g33;
				...
				float3 specularResult61_g33 = localAdditionalLightsSpecular14x70_g33;
				float3 LightColorAtten1105_g32 = ( ase_lightAtten * ase_lightColor.rgb );
				float3 normalizeResult1197_g32 = normalize( ( ase_worldViewDir + SafeNormalize(_MainLightPosition.xyz) ) );
				float dotResult1187_g32 = dot( normalizeResult1197_g32 , worldNormal1260_g32 );
				float3 temp_output_1192_0_g32 = ( temp_output_1196_0_g32 * LightColorAtten1105_g32 * pow( max( dotResult1187_g32 , 0.0 ) , exp2( (_IndirectSpecularSmoothness*10.0 + 1.0) ) ) );
				float3 temp_output_1202_0_g32 = ( specularResult61_g33 + temp_output_1192_0_g32 );
				float3 BaseColor1240_g32 = temp_output_898_0_g32;
				float3 switchResult1238_g32 = (((ase_vface>0)?(( temp_output_1202_0_g32 + 0.0 )):(BaseColor1240_g32)));
				float fresnelNdotV1262_g32 = dot( worldNormal1260_g32, ase_worldViewDir );
				float fresnelNode1262_g32 = ( 0.04 + _IndirectSpecularSmoothness * pow( 1.0 - fresnelNdotV1262_g32, 5.0 ) );
				float3 lerpResult1236_g32 = lerp( temp_output_1210_0_g32 , switchResult1238_g32 , saturate( fresnelNode1262_g32 ));
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN , bool ase_vface : SV_IsFrontFace ) : SV_TARGET
			{
				...
				float3 tanNormal1158_g32 = Normal1069_g32;
				float3 worldNormal1158_g32 = normalize( float3(dot(tanToWorld0,tanNormal1158_g32), dot(tanToWorld1,tanNormal1158_g32), dot(tanToWorld2,tanNormal1158_g32)) );
				float2 temp_output_1219_0_g32 = (IN.ase_texcoord2.zw*(unity_LightmapST).xy + (unity_LightmapST).zw);
				float2 UV1Static1247_g32 = temp_output_1219_0_g32;
				float2 temp_output_1255_0_g32 = (IN.ase_texcoord6.xy*(unity_DynamicLightmapST).xy + (unity_DynamicLightmapST).zw);
				float2 UV2Dynamic1251_g32 = temp_output_1255_0_g32;
				float3 bakedGI1252_g32 = ASEBakedGI( worldNormal1158_g32, UV1Static1247_g32, true);
				float3 lerpResult1169_g32 = lerp( float3( 1,1,1 ) , bakedGI1252_g32 , _IndirectDiffuse);
				float3 temp_output_1173_0_g32 = ( lerpResult1169_g32 + step( float3( 1,1,1 ) , ( 1.0 - lerpResult1169_g32 ) ) );
...
Node;AmplifyShaderEditor.FunctionNode;34;144,-80;Inherit;False;Material Lighting;40;;32;b5db59747a6f5584db32cde93c4695e4;8,1290,0,1289,0,1288,0,1074,0,1323,0,1322,0,1128,1,1280,1;8;898;FLOAT3;0,0,0;False;975;FLOAT3;0,0,1;False;1081;FLOAT;0;False;1079;FLOAT;0;False;1077;FLOAT;0;False;1075;FLOAT;0;False;1246;FLOAT2;0,0;False;1250;FLOAT2;0,0;False;1;FLOAT3;894
Node;AmplifyShaderEditor.FunctionNode;52;128,288;Inherit;False;Material Baked GI;35;;48;4963945102cd7c746bbe83f48754e7cb;8,910,1,827,1,826,1,838,1,831,1,839,1,1322,0,1323,0;4;975;FLOAT3;0,0,1;False;765;FLOAT3;0,0,1;False;1246;FLOAT2;0,0;False;1250;FLOAT2;0,0;False;2;FLOAT3;948;FLOAT3;949
...
ASEEND*/
//CHKSM=3A27C436A53A27663805C6247D4910B5243835BA