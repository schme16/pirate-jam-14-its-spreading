...
Shader "AmplifyShaderPack/Baked GI Standard"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 CalculateShadowMask1_g35( half2 LightmapUV )
			{
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float2 temp_output_1219_0_g31 = (IN.ase_texcoord8.zw*(unity_LightmapST).xy + (unity_LightmapST).zw);
				float2 UV1Static1247_g31 = temp_output_1219_0_g31;
				float2 temp_output_1255_0_g31 = (IN.ase_texcoord9.xy*(unity_DynamicLightmapST).xy + (unity_DynamicLightmapST).zw);
				...
				float3 lerpResult1169_g31 = lerp( float3( 1,1,1 ) , bakedGI1252_g31 , _IndirectDiffuse);
				float3 temp_output_1173_0_g31 = ( lerpResult1169_g31 + step( float3( 1,1,1 ) , ( 1.0 - lerpResult1169_g31 ) ) );
				float ase_lightAtten = 0;
				Light ase_mainLight = GetMainLight( ShadowCoords );
				ase_lightAtten = ase_mainLight.distanceAttenuation * ase_mainLight.shadowAttenuation;
				float temp_output_1108_0_g31 = ( 1.0 - ( ( 1.0 - ase_lightAtten ) * _MainLightPosition.w ) );
				...
				float lerpResult1130_g31 = lerp( ( _ShadowStrength * _ShadowStrength * 0.7978846 ) , ( _ShadowStrength * _ShadowStrength * sqrt( ( 2.0 / ( 2.0 * PI ) ) ) ) , _ShadowApproxmation);
				float RoughnessApproxmation1138_g31 = lerpResult1130_g31;
				float temp_output_1312_0_g31 = ( ( max( Dot_NdotL1100_g31 , 0.0 ) * RoughnessApproxmation1138_g31 ) + ( 1.0 - RoughnessApproxmation1138_g31 ) );
				float temp_output_1308_0_g31 = ( max( Dot_NdotH1098_g31 , 0.0 ) * temp_output_1312_0_g31 * temp_output_1312_0_g31 );
				float3 worldPosValue44_g37 = WorldPosition;
				float3 WorldPosition86_g37 = worldPosValue44_g37;
				float4 ase_screenPosNorm = ScreenPos / ScreenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float2 ScreenUV75_g37 = (ase_screenPosNorm).xy;
				float2 ScreenUV86_g37 = ScreenUV75_g37;
				float3 tanNormal12_g37 = Normal1069_g31;
				float3 worldNormal12_g37 = normalize( float3(dot(tanToWorld0,tanNormal12_g37), dot(tanToWorld1,tanNormal12_g37), dot(tanToWorld2,tanNormal12_g37)) );
				float3 worldNormalValue50_g37 = worldNormal12_g37;
				float3 WorldNormal86_g37 = worldNormalValue50_g37;
				half2 LightmapUV1_g35 = UV2Dynamic1251_g31;
				half4 localCalculateShadowMask1_g35 = CalculateShadowMask1_g35( LightmapUV1_g35 );
				float4 shadowMaskValue33_g37 = localCalculateShadowMask1_g35;
				float4 ShadowMask86_g37 = shadowMaskValue33_g37;
				float3 localAdditionalLightsLambertMask14x86_g37 = AdditionalLightsLambertMask14x( WorldPosition86_g37 , ScreenUV86_g37 , WorldNormal86_g37 , ShadowMask86_g37 );
				float3 lambertResult38_g37 = localAdditionalLightsLambertMask14x86_g37;
				float3 temp_cast_1 = (temp_output_1108_0_g31).xxx;
				float3 lerpResult1109_g31 = lerp( ( saturate( ( ( ( temp_output_1308_0_g31 * lambertResult38_g37 ) + _ShadowOffset ) / _ShadowSharpness ) ) * ase_lightAtten ) , temp_cast_1 , _ShadowStrength);
				float3 LightColor1348_g31 = ase_lightColor.rgb;
				float3 temp_output_1125_0_g31 = ( lerpResult1109_g31 * LightColor1348_g31 * ( ( 1.0 - _ShadowIntensity ) * 10.0 ) );
				...
				float3 temp_output_1210_0_g31 = saturate( ( ( temp_output_1112_0_g31 + temp_output_1125_0_g31 ) * temp_output_898_0_g31 ) );
				float3 worldPosValue44_g32 = WorldPosition;
				float3 WorldPosition70_g32 = worldPosValue44_g32;
				float2 ScreenUV75_g32 = (ase_screenPosNorm).xy;
				float2 ScreenUV70_g32 = ScreenUV75_g32;
				...
				float3 worldNormalValue50_g32 = worldNormal1260_g31;
				float3 WorldNormal70_g32 = worldNormalValue50_g32;
				float3 temp_output_15_0_g32 = WorldViewDirection;
				float3 WorldView70_g32 = temp_output_15_0_g32;
				float3 temp_output_1196_0_g31 = (_IndirectSpecularColor).rgb;
				float3 temp_output_14_0_g32 = temp_output_1196_0_g31;
				float3 SpecColor70_g32 = temp_output_14_0_g32;
				float temp_output_18_0_g32 = _IndirectSpecularSmoothness;
				float Smoothness70_g32 = temp_output_18_0_g32;
				float3 localAdditionalLightsSpecular14x70_g32 = AdditionalLightsSpecular14x( WorldPosition70_g32 , ScreenUV70_g32 , WorldNormal70_g32 , WorldView70_g32 , SpecColor70_g32 , Smoothness70_g32 );
				float3 specularResult61_g32 = localAdditionalLightsSpecular14x70_g32;
				float3 LightColorAtten1105_g31 = ( ase_lightAtten * ase_lightColor.rgb );
				...
				float3 temp_output_1202_0_g31 = ( specularResult61_g32 + temp_output_1192_0_g31 );
				float3 BaseColor1240_g31 = temp_output_898_0_g31;
				float3 switchResult1238_g31 = (((ase_vface>0)?(( temp_output_1202_0_g31 + 0.0 )):(BaseColor1240_g31)));
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN , bool ase_vface : SV_IsFrontFace ) : SV_TARGET
			{
				...
				float3 tanNormal1158_g31 = Normal1069_g31;
				float3 worldNormal1158_g31 = normalize( float3(dot(tanToWorld0,tanNormal1158_g31), dot(tanToWorld1,tanNormal1158_g31), dot(tanToWorld2,tanNormal1158_g31)) );
				float2 temp_output_1219_0_g31 = (IN.ase_texcoord4.zw*(unity_LightmapST).xy + (unity_LightmapST).zw);
				float2 UV1Static1247_g31 = temp_output_1219_0_g31;
				float2 temp_output_1255_0_g31 = (IN.ase_texcoord8.xy*(unity_DynamicLightmapST).xy + (unity_DynamicLightmapST).zw);
				float2 UV2Dynamic1251_g31 = temp_output_1255_0_g31;
				float3 bakedGI1252_g31 = ASEBakedGI( worldNormal1158_g31, UV1Static1247_g31, true);
				float3 lerpResult1169_g31 = lerp( float3( 1,1,1 ) , bakedGI1252_g31 , _IndirectDiffuse);
				float3 temp_output_1173_0_g31 = ( lerpResult1169_g31 + step( float3( 1,1,1 ) , ( 1.0 - lerpResult1169_g31 ) ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN , bool ase_vface : SV_IsFrontFace ) : SV_TARGET
			{
				...
				float3 tanNormal1158_g31 = Normal1069_g31;
				float3 worldNormal1158_g31 = normalize( float3(dot(tanToWorld0,tanNormal1158_g31), dot(tanToWorld1,tanNormal1158_g31), dot(tanToWorld2,tanNormal1158_g31)) );
				float2 temp_output_1219_0_g31 = (IN.ase_texcoord2.zw*(unity_LightmapST).xy + (unity_LightmapST).zw);
				float2 UV1Static1247_g31 = temp_output_1219_0_g31;
				float2 temp_output_1255_0_g31 = (IN.ase_texcoord6.xy*(unity_DynamicLightmapST).xy + (unity_DynamicLightmapST).zw);
				float2 UV2Dynamic1251_g31 = temp_output_1255_0_g31;
				float3 bakedGI1252_g31 = ASEBakedGI( worldNormal1158_g31, UV1Static1247_g31, true);
				float3 lerpResult1169_g31 = lerp( float3( 1,1,1 ) , bakedGI1252_g31 , _IndirectDiffuse);
				float3 temp_output_1173_0_g31 = ( lerpResult1169_g31 + step( float3( 1,1,1 ) , ( 1.0 - lerpResult1169_g31 ) ) );
...
ASEEND*/
//CHKSM=582D26CEE71D258714356B6AE8326BA93F1D950B