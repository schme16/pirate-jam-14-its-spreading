...
Shader "AmplifyShaderPack/Baked GI Specular"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 CalculateShadowMask1_g18( half2 LightmapUV )
			{
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float2 temp_output_1219_0_g8 = (IN.ase_texcoord8.zw*(unity_LightmapST).xy + (unity_LightmapST).zw);
				float2 UV1Static1247_g8 = temp_output_1219_0_g8;
				float2 temp_output_1255_0_g8 = (IN.ase_texcoord9.xy*(unity_DynamicLightmapST).xy + (unity_DynamicLightmapST).zw);
				float2 UV2Dynamic1251_g8 = temp_output_1255_0_g8;
				float3 bakedGI1252_g8 = ASEBakedGI( worldNormal1158_g8, UV1Static1247_g8, true);
				float3 lerpResult1169_g8 = lerp( float3( 1,1,1 ) , bakedGI1252_g8 , _IndirectDiffuse);
				float3 temp_output_1173_0_g8 = ( lerpResult1169_g8 + step( float3( 1,1,1 ) , ( 1.0 - lerpResult1169_g8 ) ) );
				float ase_lightAtten = 0;
				Light ase_mainLight = GetMainLight( ShadowCoords );
				ase_lightAtten = ase_mainLight.distanceAttenuation * ase_mainLight.shadowAttenuation;
				float temp_output_1108_0_g8 = ( 1.0 - ( ( 1.0 - ase_lightAtten ) * _MainLightPosition.w ) );
				...
				float lerpResult1130_g8 = lerp( ( _ShadowStrength * _ShadowStrength * 0.7978846 ) , ( _ShadowStrength * _ShadowStrength * sqrt( ( 2.0 / ( 2.0 * PI ) ) ) ) , _ShadowApproxmation);
				float RoughnessApproxmation1138_g8 = lerpResult1130_g8;
				float temp_output_1312_0_g8 = ( ( max( Dot_NdotL1100_g8 , 0.0 ) * RoughnessApproxmation1138_g8 ) + ( 1.0 - RoughnessApproxmation1138_g8 ) );
				float temp_output_1308_0_g8 = ( max( Dot_NdotH1098_g8 , 0.0 ) * temp_output_1312_0_g8 * temp_output_1312_0_g8 );
				float3 worldPosValue44_g20 = WorldPosition;
				float3 WorldPosition86_g20 = worldPosValue44_g20;
				float4 ase_screenPosNorm = ScreenPos / ScreenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float2 ScreenUV75_g20 = (ase_screenPosNorm).xy;
				float2 ScreenUV86_g20 = ScreenUV75_g20;
				float3 tanNormal12_g20 = Normal1069_g8;
				float3 worldNormal12_g20 = normalize( float3(dot(tanToWorld0,tanNormal12_g20), dot(tanToWorld1,tanNormal12_g20), dot(tanToWorld2,tanNormal12_g20)) );
				float3 worldNormalValue50_g20 = worldNormal12_g20;
				float3 WorldNormal86_g20 = worldNormalValue50_g20;
				half2 LightmapUV1_g18 = UV2Dynamic1251_g8;
				half4 localCalculateShadowMask1_g18 = CalculateShadowMask1_g18( LightmapUV1_g18 );
				float4 shadowMaskValue33_g20 = localCalculateShadowMask1_g18;
				float4 ShadowMask86_g20 = shadowMaskValue33_g20;
				float3 localAdditionalLightsLambertMask14x86_g20 = AdditionalLightsLambertMask14x( WorldPosition86_g20 , ScreenUV86_g20 , WorldNormal86_g20 , ShadowMask86_g20 );
				float3 lambertResult38_g20 = localAdditionalLightsLambertMask14x86_g20;
				float3 temp_cast_1 = (temp_output_1108_0_g8).xxx;
				float3 lerpResult1109_g8 = lerp( ( saturate( ( ( ( temp_output_1308_0_g8 * lambertResult38_g20 ) + _ShadowOffset ) / _ShadowSharpness ) ) * ase_lightAtten ) , temp_cast_1 , _ShadowStrength);
				float3 LightColor1348_g8 = ase_lightColor.rgb;
				float3 temp_output_1125_0_g8 = ( lerpResult1109_g8 * LightColor1348_g8 * ( ( 1.0 - _ShadowIntensity ) * 10.0 ) );
				...
				float3 temp_output_1210_0_g8 = saturate( ( ( temp_output_1112_0_g8 + temp_output_1125_0_g8 ) * temp_output_898_0_g8 ) );
				float3 worldPosValue44_g12 = WorldPosition;
				float3 WorldPosition70_g12 = worldPosValue44_g12;
				float2 ScreenUV75_g12 = (ase_screenPosNorm).xy;
				float2 ScreenUV70_g12 = ScreenUV75_g12;
				...
				float3 worldNormalValue50_g12 = worldNormal1260_g8;
				float3 WorldNormal70_g12 = worldNormalValue50_g12;
				float3 temp_output_15_0_g12 = WorldViewDirection;
				float3 WorldView70_g12 = temp_output_15_0_g12;
				float3 temp_output_1196_0_g8 = (_IndirectSpecularColor).rgb;
				float3 temp_output_14_0_g12 = temp_output_1196_0_g8;
				float3 SpecColor70_g12 = temp_output_14_0_g12;
				float temp_output_18_0_g12 = _IndirectSpecularSmoothness;
				float Smoothness70_g12 = temp_output_18_0_g12;
				float3 localAdditionalLightsSpecular14x70_g12 = AdditionalLightsSpecular14x( WorldPosition70_g12 , ScreenUV70_g12 , WorldNormal70_g12 , WorldView70_g12 , SpecColor70_g12 , Smoothness70_g12 );
				float3 specularResult61_g12 = localAdditionalLightsSpecular14x70_g12;
				float3 LightColorAtten1105_g8 = ( ase_lightAtten * ase_lightColor.rgb );
				...
				float3 temp_output_1202_0_g8 = ( specularResult61_g12 + temp_output_1192_0_g8 );
				...
				float2 temp_output_1219_0_g26 = (IN.ase_texcoord8.zw*(unity_LightmapST).xy + (unity_LightmapST).zw);
				float2 UV1Static1247_g26 = temp_output_1219_0_g26;
				float2 staticUV965_g26 = UV1Static1247_g26;
				float2 temp_output_1255_0_g26 = (IN.ase_texcoord9.xy*(unity_DynamicLightmapST).xy + (unity_DynamicLightmapST).zw);
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN , bool ase_vface : SV_IsFrontFace ) : SV_TARGET
			{
				...
				float3 tanNormal1158_g8 = Normal1069_g8;
				float3 worldNormal1158_g8 = normalize( float3(dot(tanToWorld0,tanNormal1158_g8), dot(tanToWorld1,tanNormal1158_g8), dot(tanToWorld2,tanNormal1158_g8)) );
				float2 temp_output_1219_0_g8 = (IN.ase_texcoord4.zw*(unity_LightmapST).xy + (unity_LightmapST).zw);
				float2 UV1Static1247_g8 = temp_output_1219_0_g8;
				float2 temp_output_1255_0_g8 = (IN.ase_texcoord8.xy*(unity_DynamicLightmapST).xy + (unity_DynamicLightmapST).zw);
				float2 UV2Dynamic1251_g8 = temp_output_1255_0_g8;
				float3 bakedGI1252_g8 = ASEBakedGI( worldNormal1158_g8, UV1Static1247_g8, true);
				float3 lerpResult1169_g8 = lerp( float3( 1,1,1 ) , bakedGI1252_g8 , _IndirectDiffuse);
				float3 temp_output_1173_0_g8 = ( lerpResult1169_g8 + step( float3( 1,1,1 ) , ( 1.0 - lerpResult1169_g8 ) ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN , bool ase_vface : SV_IsFrontFace ) : SV_TARGET
			{
				...
				float3 tanNormal1158_g8 = Normal1069_g8;
				float3 worldNormal1158_g8 = normalize( float3(dot(tanToWorld0,tanNormal1158_g8), dot(tanToWorld1,tanNormal1158_g8), dot(tanToWorld2,tanNormal1158_g8)) );
				float2 temp_output_1219_0_g8 = (IN.ase_texcoord2.zw*(unity_LightmapST).xy + (unity_LightmapST).zw);
				float2 UV1Static1247_g8 = temp_output_1219_0_g8;
				float2 temp_output_1255_0_g8 = (IN.ase_texcoord6.xy*(unity_DynamicLightmapST).xy + (unity_DynamicLightmapST).zw);
				float2 UV2Dynamic1251_g8 = temp_output_1255_0_g8;
				float3 bakedGI1252_g8 = ASEBakedGI( worldNormal1158_g8, UV1Static1247_g8, true);
				float3 lerpResult1169_g8 = lerp( float3( 1,1,1 ) , bakedGI1252_g8 , _IndirectDiffuse);
				float3 temp_output_1173_0_g8 = ( lerpResult1169_g8 + step( float3( 1,1,1 ) , ( 1.0 - lerpResult1169_g8 ) ) );
...
Node;AmplifyShaderEditor.FunctionNode;34;160,-96;Inherit;False;Material Lighting;40;;8;b5db59747a6f5584db32cde93c4695e4;8,1290,0,1289,0,1288,0,1074,0,1323,0,1322,0,1128,1,1280,1;8;898;FLOAT3;0,0,0;False;975;FLOAT3;0,0,1;False;1081;FLOAT;0;False;1079;FLOAT;0;False;1077;FLOAT;0;False;1075;FLOAT;0;False;1246;FLOAT2;0,0;False;1250;FLOAT2;0,0;False;1;FLOAT3;894
Node;AmplifyShaderEditor.FunctionNode;52;160,208;Inherit;False;Material Baked GI;35;;26;4963945102cd7c746bbe83f48754e7cb;8,910,1,827,1,826,1,838,1,831,1,839,1,1322,0,1323,0;4;975;FLOAT3;0,0,1;False;765;FLOAT3;0,0,1;False;1246;FLOAT2;0,0;False;1250;FLOAT2;0,0;False;2;FLOAT3;948;FLOAT3;949
...
ASEEND*/
//CHKSM=0AB8A8659A29B689D76EA193B53A65662658AD72