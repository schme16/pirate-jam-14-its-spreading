	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 )
			{
				...
				ase_tanViewDir = normalize(ase_tanViewDir);
				float2 appendResult47 = (float2(_CurvatureU , _CurvatureV));
				float2 OffsetPOM8 = POM( _HeightMap, uv_Albedo, ddx(uv_Albedo), ddy(uv_Albedo), WorldNormal, ase_worldViewDir, ase_tanViewDir, 128, 128, _Scale, 0, _HeightMap_ST.xy, appendResult47, 0 );
				float2 customUVs39 = OffsetPOM8;
				float2 temp_output_40_0 = ddx( uv_Albedo );
				float2 temp_output_41_0 = ddy( uv_Albedo );
				float3 unpack14 = UnpackNormalScale( tex2D( _Normal, customUVs39, temp_output_40_0, temp_output_41_0 ), _NormalScale );
...
Node;AmplifyShaderEditor.ParallaxOcclusionMappingNode;8;-1032.9,-21.1;Inherit;False;0;128;False;;128;False;;10;0.02;0;False;1,1;True;10,0;8;0;FLOAT2;0,0;False;1;SAMPLER2D;;False;7;SAMPLERSTATE;;False;2;FLOAT;0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;5;FLOAT2;0,0;False;6;FLOAT;0;False;1;FLOAT2;0
...
ASEEND*/
//CHKSM=CA9EBF498148B19F688ABBB1F0D3D464EE570EAC