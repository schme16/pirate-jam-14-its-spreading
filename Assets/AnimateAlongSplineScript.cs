...
public class AnimateAlongSplineScript : MonoBehaviour
{
	...
	private void Start()
	{
		...
		currentSpline = spline.Splines[0];
	}
	...
	private void FixedUpdate()
	{
		...
		//Vector3 offsetPosition = new(nearest.x + spline.transform.position.x,nearest.y + spline.transform.position.y,nearest.z + spline.transform.position.z);
